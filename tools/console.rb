...
satan = Cult.new("Satan Worshiper", "Mordor", 1730 , "There can only be one ring", 30)
elves = Cult.new("The Light", "Rivendale" , 1709, "Humans are weak but we must prevail", 18)
other_elves = Cult.new("The Forest", "Rivendale" , 1715, "We are witch elves", 18)
